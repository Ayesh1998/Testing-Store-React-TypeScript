...
const HeaderTwo: React.SFC<HeaderTwoProps> = () => {
  const dispatch = useDispatch();

  const cartItems = useSelector((state: StoreStates) => state.cartItems);
  const toggleDropdownstate = useSelector(
    (state: StoreStates) => state.toggleDropdown
  );
